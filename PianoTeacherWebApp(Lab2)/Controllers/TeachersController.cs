...
namespace PianoTeacherWebApp_Lab2_.Controllers
{
    ...
    public class TeachersController : ControllerBase
    {
        ...
        public TeachersController(PianoTeacherAPIContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Teachers
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Teacher>>> GetTeacher_1()
        {
        ...
        public async Task<ActionResult<Teacher>> PostTeacher(Teacher teacher)
        {
          if (_context.Teacher == null)
          {
              return Problem("Entity set 'PianoTeacherAPIContext.Teacher_1'  is null.");
          }
